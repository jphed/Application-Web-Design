    ...
    public function run(): void
    {
        $tickets = [
            ...
            [
                ...
                'cliente_email' => 'm.garcia@empresa.com',
                'departamento' => 'Recursos Humanos',
                'categoria' => 'software',
                'nivel_urgencia' => 'alta',
                'descripcion_corta' => 'No puedo acceder al sistema de nomina',
                'descripcion_detallada' => 'Al intentar ingresar con mis credenciales el sistema muestra error 503',
                'tecnico_asignado' => 'Carlos Mendez',
                'fecha_reporte' => '2024-01-15 09:30:00',
                'fecha_promesa' => '2024-01-15 14:00:00',
                'status' => 'pendiente',
            ],
        ];
