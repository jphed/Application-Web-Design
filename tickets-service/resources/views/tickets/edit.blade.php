...
rows="3">{{ $ticket->descripcion_detallada }}</textarea>
 </div>
 <div class="col-md-6">
...
rows="3">{{ $ticket->comentarios_tecnico }}</textarea>
 </div>
 <div class="col-12">
 <label class="form-label fw-semibold">Adjuntar imágenes y documentos adicionales</label>
